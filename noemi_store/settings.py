"""
Django settings for noemi_store project.
...
SECRET_KEY = 'django-insecure-$g%bu(clatbf(_mp@ab-i6((-*dhb9&dmi4u$5t^lsri5&i28_'
...
WSGI_APPLICATION = 'noemi_store.wsgi.application'
